import { database } from "./firebaseConfig.js"; // Asegúrate de la ruta correcta
import { ref, set } from "firebase/database"; // Para guardar los datos en la base de datos
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function saveScore() {
      if (!playerName) {
          console.error("El nombre del jugador es necesario.");
          return;
      }
